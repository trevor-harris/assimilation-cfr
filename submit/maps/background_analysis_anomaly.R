...
nc.post = nc_open('../assimilation-cfr/data/tas_ens_da_hydro_r.1000-2000_d.16-Feb-2018.nc')
prior_ind = read.csv("../assimilation-cfr/data/prior-ens.txt", header = F)$V1

prior.all = prep_prior(nc.prior)[,,prior_ind]
