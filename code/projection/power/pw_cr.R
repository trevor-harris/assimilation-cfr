...
for (i in 1:simulations) {
  ...
  post.gp = sim_gp(mu = prior_mu + mean_shift, l = 1, pts = 40)
...
cat("#### Saving Data \n")
saveRDS(diffs, file = paste0("../../../outdata/pointwise/depth_cr_high_", mean_shift,".rds"))
saveRDS(diffs_pw, file = paste0("../../../outdata/pointwise/pw_cr_high_", mean_shift,".rds"))
saveRDS(diffs_bf, file = paste0("../../../outdata/pointwise/bf_cr_high_", mean_shift,".rds"))
