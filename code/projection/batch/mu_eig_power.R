...
for (i in 1:simulations) {
  ...
  kol.field = kst.field.eig(sim.prior.split, sim.post.split, eigen = 20)
...
cat("#### Saving Data \n")
saveRDS(diffs, file = paste0("../../../outdata/mu_eig_const_", mean_shift,".rds"))
