...
##### ACTUAL CLIMATE ##### 
field_plot2(prior[,,10], nc.post, main = "", downsamp = 1)
ggsave("../research/assimilation-cfr/paper/misc/background.png")


field_plot2(post[,,10], nc.post, main = "", downsamp = 1)
ggsave("../research/assimilation-cfr/paper/misc/analysis.png")
