...
cat("#### Saving Data \n")
saveRDS(upper_de, file = paste0("/home/trevorh2/assimilation-cfr/sim_study/power/mean/simulations/realistic_depth", batch_no, ".rds"))
saveRDS(upper_bf, file = paste0("/home/trevorh2/assimilation-cfr/sim_study/power/mean/simulations/realistic_bonferroni", batch_no, ".rds"))
saveRDS(upper_pw, file = paste0("/home/trevorh2/assimilation-cfr/sim_study/power/mean/simulations/realistic_pointwise", batch_no, ".rds"))
saveRDS(ks_value, file = paste0("/home/trevorh2/assimilation-cfr/sim_study/power/mean/simulations/realistic_KST", batch_no, ".rds"))
